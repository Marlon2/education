...
<body>
	...
	<div class="w" id="regist">
		<div class="mt">
			<ul class="tab">
				<li class="line">
					<a href="jsp/register.jsp">学生注册</a>
				</li>
				<li class="curr">老师注册</li>
			</ul>
		</div>
		<div class="menu">
			<form action="<%=basePath%>register_saveTeacher.action" method="post"
				id="registForm">
					...
					<tbody>
						<tr>
							...
							<td class="righttd"><input type="text" class="mustInput"
								name="teacher.name" value="${student.name }" /><font
								color="red">*</font></td>
						</tr>
						<tr>
							<td class="lefttd">学员性别：</td>
							<td class="righttd"><input type="radio" name="teacher.sex"
						...
						<tr>
							...
							<td class="righttd"><input type="text" class="number"
								name="teacher.mobilenumber" maxlength="11" /><font color="red">*</font></td>
						</tr>
						<tr>
							<td class="lefttd">电子邮箱：</td>
							<td class="righttd"><input type="text" class="email"
								name="teacher.email"><font color="red">*</font></td>
						</tr>
						
						<tr>
							<td class="lefttd">设置密码：</td>
							<td class="righttd"><input id="psw" class="mustInput"
								class="mustInput" type="password" name="teacher.password" /><font
								color="red">*</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="righttd" class="righttd"><font color="red"
								style="width: 20px;"><s:property value="message"/></font></td>
						</tr>
						<tr>
							<td class="lefttd"></td>
							<td class="righttd">
								<input class="registerbtn" id="regist" type="button" value="立即注册" />
							</td>
						</tr>
					</tbody>
				</table>
